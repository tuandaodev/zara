...
function gs_wv_help_menu() {

	add_submenu_page( 
	    'gsp-main', 
	    'Help', 
	    'Variation Help & Usage', 
	    'manage_options', 
	    'gs-wv-help', 
	    'gswv_help_menu_cb'
	);
...
add_action('admin_menu', 'gs_wv_help_menu', 11);

function gswv_help_menu_cb() {
	?>

    <div class="wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 50px; text-align: center;">
	        <h1>GS WooCommerce Variation  by GS Plugins</h1>
			<br>
			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsamdani.com/product/woocommerce-variation-swatches" target="_blank">Plugin Home</a>
			<a class="gstm-hlp-btn gstm-btn-2" href="http://woovariation.gsamdani.com" target="_blank">Live Demo</a>
			<a class="gstm-hlp-btn gstm-btn-3" href="http://woovariation.gsamdani.com/documentation" target="_blank">Documentation</a>
			<!-- <a class="gstm-hlp-btn gstm-btn-4" href="#" target="_blank">Shortcode Usage</a> -->
        ...
        <div class="gswps-admin-sidebar" style="width: 277px; float: left; margin-top: 62px; text-align: center;">
            <div class="postbox">
