...
if( ! class_exists( 'GSPlugins_team_free' ) ){
    
    class GSPlugins_team_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_team_free ) {
                self::$_instance = new GSPlugins_team_free();
            }
    ...
    $gsplugin_free = GSPlugins_team_free::get_instance();
}