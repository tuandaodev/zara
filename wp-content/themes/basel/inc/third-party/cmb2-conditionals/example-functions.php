...
function yourprefix_register_conditionals_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'    => esc_html__( 'Test Multi Checkbox', 'basel' ),
		'desc'    => esc_html__( 'field description (optional)', 'basel' ),
		'id'      => $prefix . 'multi-checkbox',
		'type'    => 'multicheck',
		'options' => array(
			'check1' => esc_html__( 'Check One', 'basel' ),
			'check2' => esc_html__( 'Check Two', 'basel' ),
			'check3' => esc_html__( 'Check Three', 'basel' ),
		),
	) );
